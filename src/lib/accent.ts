...
export const ACCENT: Record<Accent, { text: string; onDark: string; pill: string; rule: string; glow: string; hover: string }> = {
  purple: { text: "text-mt-purple", onDark: "text-mt-purple-light", pill: "border-mt-purple/25 bg-mt-surface text-mt-purple", rule: "bg-mt-purple", glow: "#6B2FD9", hover: "hover:border-mt-purple-light" },
