...
export const metadata: Metadata = { openGraph: { images: [ogCard("Terms of service", "Legal")] }, title: "Terms of service", description: "Terms governing use of the Manuel Technologies website and its free tools.", alternates: { canonical: "/terms-of-service" } };
